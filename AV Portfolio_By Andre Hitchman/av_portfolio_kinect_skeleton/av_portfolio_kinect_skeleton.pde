...
void draw() {
  background(0);
  sendData(); //refresh
  ellipse(hx, hy, 40, 60); // head
  fill(255, 50, 50);
  ellipse(lhx, lhy, 30, 30);// left hand
  fill(50, 50, 255);
  ellipse(rhx, rhy, 30, 30); // right hand
  stroke(255, 255, 255);
   
 
  ellipse(rex, rey, 30, 30); // right elbow
  ellipse(lex, ley, 30, 30); // left elbow
  ellipse(rfx, rfy, 20, 20); // right foot
  ellipse(lfx, lfy, 20, 20); // left foot
  ellipse(rkx, rky, 30, 30); // right knee
  ellipse(lkx, lky, 30, 30); // left knee
  ellipse(tx, ty, 30, 30); // hip joint
